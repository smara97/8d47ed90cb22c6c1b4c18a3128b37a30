#!/usr/bin/env python3
"""
captioner service Service - Video RAG System

Processes video frames using blip method for captioner-service analysis
"""
...
class captionerserviceService:
    """Processes video frames using blip method for captioner-service analysis"""
    
    def __init__(self):
        self.kafka_servers = "kafka:9092"
        self.consumer_group = "captioner-service-group"
        self.input_topic = "raw-frames"
        self.output_topic = "caption-results"
        self.service_name = "captioner-service"
    ...
    def process_frame(self, frame_data):
        ...
        try:
            ...
            result = {
                ...
                "results": {
                    "captioner-service_data": f"Processed by {self.service_name}",
                    "confidence": 0.95,
                    "processing_method": "blip"
                },
...
app = FastAPI(title="captioner service Service", version="1.0.0")

# Global service instance
service = captionerserviceService()
