#!/usr/bin/env python3
"""
detector service Service - Video RAG System

Processes video frames using yolo method for detector-service analysis
"""
...
class detectorserviceService:
    """Processes video frames using yolo method for detector-service analysis"""
    
    def __init__(self):
        self.kafka_servers = "kafka:9092"
        self.consumer_group = "detector-service-group"
        self.input_topic = "raw-frames"
        self.output_topic = "detection-results"
        self.service_name = "detector-service"
    ...
    def process_frame(self, frame_data):
        ...
        try:
            ...
            result = {
                ...
                "results": {
                    "detector-service_data": f"Processed by {self.service_name}",
                    "confidence": 0.95,
                    "processing_method": "yolo"
                },
...
app = FastAPI(title="detector service Service", version="1.0.0")

# Global service instance
service = detectorserviceService()
