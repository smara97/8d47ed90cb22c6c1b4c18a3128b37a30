...
Processes video frames using vector-store method for frame-aggregator analysis
"""
...
class frameaggregatorService:
    """Processes video frames using vector-store method for frame-aggregator analysis"""
    
    def __init__(self):
        self.kafka_servers = "kafka:9092"
        self.consumer_group = "frame-aggregator-group"
        self.input_topic = "caption-results"
        self.output_topic = "aggregated-results"
        self.service_name = "frame-aggregator"
    ...
    def process_frame(self, frame_data):
        ...
        try:
            ...
            result = {
                ...
                "results": {
                    "frame-aggregator_data": f"Processed by {self.service_name}",
                    "confidence": 0.95,
                    "processing_method": "vector-store"
                },
...
service = frameaggregatorService()
